<script lang="ts">
	import LineChartEducationGeneric from './LineChartEducationGeneric.svelte';
	import OptionsSelectorGeneric from './OptionsSelectorGeneric.svelte';
...
<section class="flex w-full flex-col items-center justify-center bg-yellow-50 p-5">
